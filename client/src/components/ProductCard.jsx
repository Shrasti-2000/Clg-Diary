    ...
    <div className="bg-white rounded-2xl shadow-sm overflow-hidden hover:-translate-y-1 hover:shadow-xl transition-all duration-300 group">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mt-4">
          <div>
            <p className="text-2xl font-bold bg-gradient-to-r from-[#66023C] to-[#66023C] bg-clip-text text-transparent">
              {product?.price}
            </p>
            <p className="text-xs text-slate-500 mt-1">Listed:{product.user.name}</p>
          </div>
          <div>
