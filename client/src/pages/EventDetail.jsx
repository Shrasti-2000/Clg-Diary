...
const {event, eventLoading, eventSuccess, eventError, eventErrorMessage} = useSelector(state => state.events)
const {allComments, commentLoading, commentSuccess, commentError, commentErrorMessage} = useSelector(state => state.comments)
