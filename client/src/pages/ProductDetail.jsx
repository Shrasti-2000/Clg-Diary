...
if(productError && productErrorMessage || messageError && messageErrorMessage){
  toast.error(productError || messageErrorMessage)
}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-6 md:p-8">
            ...
            <div>
              ...
              <div className="flex gap-3">
                <button disabled={sent} onClick={() =>sendAlert(product._id)} className="flex-1 py-4 px-6 bg-gradient-to-r from-[#9A4EAE] to-[#7851A9] text-white rounded-xl font-bold hover:shadow-lg hover:scale-[1.02] transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disable:bg-green-500">
                 {sent ? " Contact Seller" : " Contact Seller"}
                </button>
