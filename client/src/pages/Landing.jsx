...
import { CircleShape, SquiggleShape, StarShape, TriangleShape } from '../assets/FloatingShape';
...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen">
      <section className="relative bg-gradient-to-br from-[#f7aef8] via-[#b388eb] to-[#8093f1] overflow-hidden">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            <Link
              to="/marketplace"
              className="inline-block px-8 py-3 bg-gradient-to-r from-[#86608E] to-[#DDA0DD] text-white rounded-full font-bold hover:shadow-lg hover:scale-105 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
            >
              View All Products →
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow text-center">
              <div className="w-16 h-16 bg-[#DDA0DD] rounded-2xl flex items-center justify-center mx-auto mb-4">
            ...
            {[
              ...
              <div key={index} className="bg-slate-50 p-6 rounded-2xl">
                <div className="flex items-center mb-4">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#86608E] to-[#9A4EAE] flex items-center justify-center text-white font-bold mr-3">
                    {testimonial.avatar}
                  </div>
                  <div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#5B3256] via-[#DBB2D1] to-[#645394] ">
